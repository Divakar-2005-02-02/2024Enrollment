...
const AssignSubjectStaff = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const subjectResponse = await axios.get('https://www.2024enrollmentit.kesug.com/admin/sub'); // URL to fetch subjects
        setSubjects(subjectResponse.data);

        const staffResponse = await axios.get('https://www.2024enrollmentit.kesug.com/staff/disp-staff'); // URL to fetch staff
  ...
  const handleAssign = async () => {
    ...
    try {
      await axios.post('https://www.2024enrollmentit.kesug.com/admin/assign-subject', assignmentData);
