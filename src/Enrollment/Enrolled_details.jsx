...
const EnrolledSubjects = () => {
  ...
  useEffect(() => {
    ...
    const fetchEnrolledSubjects = async () => {
      try {
        const enrolledResponse = await axios.get('https://www.2024enrollmentit.kesug.com/enroll/get-id', {
          params: { studentId },
        });
        ...
        const subjectStaffPromises = enrolledResponse.data.map(async (enrollment) => {
          ...
          try {
            const subjectStaffResponse = await axios.get('https://www.2024enrollmentit.kesug.com/enroll/get-subject-staff', {
